...
checkout the [quickstart](https://developer.actyx.com/docs/how-to/overview) and the [ActyxOS Node Manager](https://developer.actyx.com/docs/reference/node-manager/) to set the settings of your ActyxOS Node if it is not already done.
