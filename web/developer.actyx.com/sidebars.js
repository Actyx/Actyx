  ...
  howToSidebar: [
    'how-to/overview',
    {
      ...
      items: [
        ...
        'how-to/local-development/install-js-libs',
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        'how-to/basic-operations/publish',
        'how-to/basic-operations/query',
      ],
    },
    {
      type: 'category',
      ...
      items: [
        {
          ...
          type: 'autogenerated',
          dirName: 'reference/js-ts-sdk', // 'api' is the 'out' directory
        }
      ],
    },
    {
