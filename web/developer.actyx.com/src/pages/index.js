...
function Home() {
  return (
    <PageWrapper>
      ...
      <VerticalSpace />
      <h2>First Steps</h2>
      Discover these two sections about the Actyx platform and its products to
      get a first glimpse into the Actyx world.
      <TwoElementRow
      ...
      <TwoElementRow
        ...
        link1={[
          useBaseUrl("/docs/os/general/introduction"),
          useBaseUrl("/docs/os/api/overview"),
        ]}
        link2={[
          useBaseUrl("/docs/pond/introduction"),
          useBaseUrl("/docs/pond/guides/hello-world"),
        ]}
      />
      <VerticalSpace />
      ...
      <ThreeElementRow
        ...
        link2={useBaseUrl(
          "/docs/os/theoretical-foundation/distributed-systems"
        )}
      ...
      please <a href="https://www.actyx.com/contact">contact us</a> or join us
      in our <a href="https://discord.gg/262yJhc">Discord channel</a> and we
      will be happy to help you set up or answer any questions you might have.
      <VerticalSpace />
      <h2>Stay informed</h2>
      <StayInformed
