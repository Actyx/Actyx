...
import { Version, Change, Hash } from './types'
...
const Page: React.FC<{
  ...
  return (
    <PackagerBasedPage
      {...data}
      product="pond"
      productDisplayName="Actyx Pond"
      installation={
        <>
          <p>Install using npm:</p>
          <p>
            <code>npm i @actyx/pond{!isLatest && `@${version}`}</code>
          </p>
          <p>
            Alternatively, view package on{' '}
            <a href={`https://www.npmjs.com/package/@actyx/pond/v/${version}`}>npm.js</a>
          </p>
        </>
      }
    />
