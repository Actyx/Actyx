...
- **maxEvents:** the number of most recent events to keep. For example, if you set `maxEvents` to 1000 and currently have 1024 events store, the oldest 24 events may be deleted.
