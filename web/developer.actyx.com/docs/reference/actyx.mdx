...
All devices in an ActyxOS swarm must be connected to the same local-area network. It is recommended to keep the IP addresses relatively stable, frequent changes will reduce performance of the system.
:::

## Performance

A lot of different factors play into performance of Actyx and your apps:

- local-area network setup and latency
- runtime for your app
...
Assuming a standard network setup, typical rugged tablets or other devices with relatively low computing power, and a standard factory use case, these are the limits:
...
:::info Conceptual guide on performance and limits
These estimations are only true within the circumstances described above. If you are looking for guidande on a specific use case, please refer to our [conceptual guide](../conceptual/performance-and-limits) or contact us.
:::
...
These are example calculations for factory apps with (50% of nodes) and without machine integrations, based on real data, for a 1-year timeframe:
