...
- **initialPeers:** an array of addresses of the form `/ip4/<IP address>/tcp/<port>` to which this node shall [immediately try to connect](../how-to/swarms/connect-nodes.mdx).
