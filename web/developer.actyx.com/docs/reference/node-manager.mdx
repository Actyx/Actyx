...
![node-offsets](../../static/images/node-manager/node-offsets.png)
...
![partially-connected](../../static/images/node-manager/offset-matrix-partial.png)
...
![partially-synced](../../static/images/node-manager/offset-matrix-partially-synced.png)
...
![fully-synced](../../static/images/node-manager/offset-matrix-synced.png)
