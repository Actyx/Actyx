...
Within this allegory the active entities that consume the data are consequently called _fishes_, even though in the context of digital factories they tend to be called digital twins (or we prefer _local twins_).
:::
