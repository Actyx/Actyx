...
those events turn up. This time-travel functionality is what guarantees eventual consistency of all states machines 
in the swarm.
...
[desktop apps](../how-to/packaging/desktop-apps.mdx), and [headless apps](../how-to/packaging/headless-apps.mdx) or head over to our [advanced example](../tutorials/advanced-tutorial/packaging.mdx) to see a few packaging examples.
