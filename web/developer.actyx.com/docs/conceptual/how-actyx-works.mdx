...
There are two ways in which the business logic can be formulated:
...
- Otherwise, if the local twin models something where your application shall control or coordinate the progression through a sequence of different life cycle states than you can use [`machine-runner`](https://www.npmjs.com/package/@actyx/machine-runner) which the usage of can be found in the library documentation.
