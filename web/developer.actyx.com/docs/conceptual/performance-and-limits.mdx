...
This means that machine-runner are best used to model [short-lived](../../how-to/structured-queries/tagging-best-practices.mdx#short-lived-entities) process workflows (which rarely have more than 1,000 steps).
