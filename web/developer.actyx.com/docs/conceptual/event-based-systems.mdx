...
:::tip Actyx Pond
Check out the Actyx Pond – an auxiliary product to Actyx—which provides you with an always available, partition-tolerant event sourcing system out of the box. It also tries to mitigate some of the key associated challenges.
:::
