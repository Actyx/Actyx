...
Check out the [machine-runner](https://www.npmjs.com/package/@actyx/machine-runner) – an auxiliary product to Actyx—which enables easy choreography of distributed and heterogenous a swarm to execute a sequential workflow without complex and expensive coodination of states.
:::
