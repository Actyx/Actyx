...
The Actyx Pond is a programming framework for writing apps for Actyx. It is available on [npm](http://npmjs.com/package/@actyx/pond). Check out our [how-to guides](/docs/how-to/actyx-pond/introduction) for more information.
