...
In addition, Actyx offers [`machine-runner`](https://www.npmjs.com/package/@actyx/machine-runner), a framework running on top Actyx that enables easy choreography of distributed and heterogenous a swarm to execute a sequential workflow without complex and expensive coodination of states.
