...
It always represents one entity of your logic and should always have only a single responsibility – which means in the case of this tutorial, you need one local twin to keep track of your machines, and one that keeps track of your orders.
...
```ts title="Definition of state types"
...
```ts title="Definition of event types"
