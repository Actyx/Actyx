...
Before you can run the apps, make sure that ActyxOS is running, for a detailed installation guide, please refer to [this guide](../../how-to/local-development/install-actyx.mdx).
