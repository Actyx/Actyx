...
To understand the Advanced ActyxOS Tutorial, you should know the fundamentals of how to build an ActyxOS app using the Actyx Pond. This tutorial builds on skills taught in the [ActyxOS Chat app tutorial](../chat.mdx). Specifically, you should know how to do the following:
