...
To brefly describe the concept of tags, events going into Actyx are labeled with a tag;
...
[AQL](/docs/tutorials/aql) is a Acytx-specific language used to query events.
