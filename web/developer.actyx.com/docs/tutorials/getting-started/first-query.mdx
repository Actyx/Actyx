...
:::info
This tutorial is aimed at begginers that already know how to publish events,
if you're not sure if that is you, take a look into the [previous tutorial](./first-event).
:::

Before we start, make sure Actyx is running! If you're unsure how to do so,
you can review how to start Actyx in our [how-to guide](../../how-to/local-development/install-actyx#starting-and-stopping-actyx).
...
Finally, we can press "Query" and the results will appear in the bottom,
