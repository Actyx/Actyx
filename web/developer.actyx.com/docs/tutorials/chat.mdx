...
In this tutorial, we are going to build a small chat app using [Actyx](/docs/conceptual/overview). **You might be tempted to skip it because you are not building chats in real-life — give it a chance.** The techniques that you will learn in this tutorial are fundamental to building anything on the platform, and mastering them will give you a good understanding of its capabilities.
...
If you get stuck, ping us on our [Discord Chat](https://discord.gg/262yJhc) or e-mail the mailing list at [developer@actyx.io](mailto:developer@actyx.io).
...
_local twins_ take [digital twins](https://en.wikipedia.org/wiki/Digital_twin) from the cloud into edge computing while
Actyx enables edge computing by offering a lake of data in which programs can live and breathe — like _fishes_.
:::
...
```ts file=../../../../third-party/chat/index.ts#[import]
...
- Visit our [how-to guides](../how-to/overview.mdx) to get started immediately
- Dive into how it works with the [conceptual guides](../conceptual/overview.mdx)

:::note Join our Discord chat
Feel free to join our [Actyx Developer Chat](https://discord.gg/4RZpTqmPgC) on Discord. We would love to hear about what you want to build on the Actyx Platform.
:::
