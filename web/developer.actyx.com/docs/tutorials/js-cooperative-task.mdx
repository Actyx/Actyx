---
title: 'Cooperative Task with MachineRunner'
id: js-cooperative-task
hide_title: false
hide_table_of_contents: false
sidebar_label: 'Cooperative Task with MachineRunner'
keywords: [tutorial]
...
after served, the robots leave a safe distance and signal the pump.
Only after that sequence is finished, the next robot can come in.

A cooperation like this is usually hard, especially in a farming field where a central coordinator is absent.
Pumps and robots must agree on a sequence of tasks, who does what, and what must not happen [when another process is not finished](https://en.wikipedia.org/wiki/Race_condition).
...
This process, illustrated in pseudo-code, looks like this _(you don't have to type it in)_:
...
To illustrate (_again, you don't have to type it in_):
