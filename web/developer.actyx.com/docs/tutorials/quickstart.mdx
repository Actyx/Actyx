...
:::caution Error `ECONNREFUSED 127.0.0.1:4243`
...
- Figure out how to build on Actyx with practical [how-to guides](../how-to-guides/overview.mdx)
- Learn about the fundamentals by reading the [conceptual guides](../conceptual-guides/overview.mdx)
