...
![how-actyx-works-1](/images/conceptual-guides/how-actyx-works/how-actyx-works-1.png)
...
![how-actyx-works-2](/images/conceptual-guides/how-actyx-works/how-actyx-works-2.png)
...
![how-actyx-works-3](/images/conceptual-guides/how-actyx-works/how-actyx-works-3.png)

Local twins are implemented uin the Typescript programming language using APIs provided by the **Actyx Pond** library.
We call these twins: __**fishes**__. The logic of a fish is defined by three things:
...
![how-actyx-works-4](/images/conceptual-guides/how-actyx-works/how-actyx-works-4.png)

_**In this example, you could deploy ActyxOS to a small industrial PC that is connected to the machine (or directly to the machine's PLC) and deploy ActyxOS to a small industrial PC that you connect to the robot.**
_
...
![how-actyx-works-5](/images/conceptual-guides/how-actyx-works/how-actyx-works-5.png)

### Local interaction

After you have deployed the apps to the edge devices running ActyxOS, Twins interact and cooperate locally:

![how-actyx-works-6](/images/conceptual-guides/how-actyx-works/how-actyx-works-6.png)

Due to the local interaction of the twins, there is no dependency between environments.

![how-actyx-works-7](/images/conceptual-guides/how-actyx-works/how-actyx-works-7.png)

### Synchronization of local twins

When edge devices are connected, ActyxOS automatically synchronizes the twins in real-time:

![how-actyx-works-8](/images/conceptual-guides/how-actyx-works/how-actyx-works-8.png)

The twins' history is consistent and forever accessible:

![how-actyx-works-9](/images/conceptual-guides/how-actyx-works/how-actyx-works-9.png)

### Add new twins to the process

To extend or scale the process, you simply add new local twins:

![how-actyx-works-10](/images/conceptual-guides/how-actyx-works/how-actyx-works-10.png)
