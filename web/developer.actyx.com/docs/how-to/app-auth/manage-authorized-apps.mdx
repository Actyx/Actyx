...
:::tip you still have app license keys for Actyx v1.x?
...
```text
ax settings get com.actyx/licensing/apps -l 192.168.1.211 > example
```
...
```text
ax settings set com.actyx/licensing/apps @example -l 192.168.1.211
```
