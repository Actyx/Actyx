...
The Actyx Pond is a highly opinionated framework for building always-available distributed apps on [Actyx](../local-development/install-actyx.mdx). It provides a programming model and system guarantees ideally suitable for use-cases requiring 100% availability. With this focus, the Actyx Pond can take care of concerns like eventual consistency, allowing you to concentrate on your business logic.
...
The best way to get started is by following the tutorial, starting with the obligatory [Hello World](../actyx-pond/guides/hello-world.mdx).
