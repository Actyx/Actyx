...
It is a framework for consuming the event streams provided by the Actyx event-focused database, and it helps you make the best use of the fully distributed architecture of Actyx — it simplifies the creation of _Local-First_ applications.
