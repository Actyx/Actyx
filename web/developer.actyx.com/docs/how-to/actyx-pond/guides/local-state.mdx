...
In this section, we implement the logic for how a fish can accumulate a useful state by ingesting events.
...
If your node is part of an Actyx swarm where this tutorial has already been run, your fish might
