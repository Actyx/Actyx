...
You should see our initial greeting logged to the console – unless your swarm already has some events tagged with `dummy`, in
which case you will see the latest one!

Hint: Try `pond.emit(Tag('example-tag'), 'Eye eye')`
:::
