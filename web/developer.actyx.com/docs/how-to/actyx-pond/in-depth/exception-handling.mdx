---
title: Exception Handling with Actyx Pond
id: exception-handling
hide_title: false
hide_table_of_contents: false
sidebar_label: Exception Handling
keywords: [how-to-guide, exception handling]
description: How-to-guide for exception handling with Actyx Pond
...
:::warning
A Fish is **stopped** when one of its functions throws an error.
