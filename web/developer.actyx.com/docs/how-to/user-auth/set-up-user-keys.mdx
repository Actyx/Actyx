...
If you want to manage which users are authorized to manage a node, [you can do so by adding the user's public key to the node's settings](./manage-authorized-users).
