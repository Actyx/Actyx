---
title: Manage authorized users of a node
...
For following the steps in this guide, you need to [set up user keys](./set-up-user-keys.mdx) first.
...
![node-manager-authorized-users](../../../static/images/how-to/manage-authorized-users/authorized-users.png)
