...
- one (or more) of your nodes is a Docker node, and the Actyx container is running with the `--network=host` option
...
```text
ax settings set com.actyx/swarm/announceAddresses [/ip4/192.168.2.10/tcp/4001] localhost
```
