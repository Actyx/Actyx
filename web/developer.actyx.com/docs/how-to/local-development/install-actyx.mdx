...
:::tip On Apple Silicon: "actyx" is damaged and can't be opened.
If you see this error, run the following command in the folder where the `actyx` binary is located: `xattr -d com.apple.quarantine actyx`.
:::
