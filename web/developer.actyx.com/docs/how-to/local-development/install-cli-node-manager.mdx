...
1. Download the Actyx CLI installer for Windows from our [downloads page](https://developer.actyx.com/releases).
...
1. Download the Actyx Node Manager installer for Windows from our [downloads page](https://developer.actyx.com/releases).
...
1. Download the Actyx CLI binary file from our [downloads page](https://developer.actyx.com/releases)
...
1. Download the right binary (e.g. `actyx-node-manager_amd64.deb`) from our [downloads page](https://developer.actyx.com/releases)
...
6. To confirm the installation, use the `ax --version` command. You should see something like this:
...
1. Download the zipped Node Manager from our [downloads page](https://developer.actyx.com/releases).
