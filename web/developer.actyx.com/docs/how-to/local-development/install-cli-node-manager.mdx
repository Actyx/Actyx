...
sidebar_label: Install the CLI and Node Manager
keywords: [how-to-guide, cli, node manager]
description: How-to install the Actyx CLI and the Actyx Node Manager
...
with the CLI you can interact with your ActyxOS environment by running commands in your favorite terminal program:
