...
:::caution
Only the events of the currently configured topic are migrated. If you need to migrate events of different topics, please contact us in our [community forum](https://groups.google.com/a/actyx.io/g/developers) or on our [Discord server](https://discord.gg/262yJhc).
:::
...
![migration-03](../../../static/images/how-to/migration/migration-03.png)
...
![migration-04](../../../static/images/how-to/migration/migration-04.png)
...
:::tip adb installation
On some verions of Android, you get the error `INSTALL_FAILED_ALREADY_EXISTS` when updating an app via `adb`. You then have to run the command with the `-r` option, i.e. `adb install -r <path to the apk>`.
:::
...
If you have any problems with migrating your apps, please don't hesitate to contact us in our [community forum](https://groups.google.com/a/actyx.io/g/developers) or on our [Discord server](https://discord.gg/262yJhc).
