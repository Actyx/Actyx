...
First, open the file explorer and go to the v1 directory under `TODO`, and copy the `TODO` directory:

TODO: Screenshot

Then navigate to your v2 directory `TODO` and paste the `TODO` directory you copied before:

Finally, delete the `TODO` directory, and rename the directory you copied as `TODO`.
...
Open the Windows Event Viewer to get the Actyx logs:

TODO: Screenshot

Filter for the TODO logs:
...
```text
docker run --rm -v actyxos-data:/data -u root alpine chown -R 1000:1000 /data
```
