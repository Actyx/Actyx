...
There is the recommended approach for migrating your apps to work with Actyx 2.x:
...
:::info Migrating your production deployment to version 2?
If you want to migrate your production deployment to version 2, we strongly recommend waiting for version 2.1.
