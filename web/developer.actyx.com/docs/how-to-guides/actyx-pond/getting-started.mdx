---
title: Getting Started with Actyx Pond
id: getting-started
hide_title: false
hide_table_of_contents: false
sidebar_label: Getting Started
keywords: [how-to-guide, getting, started]
description: How-to-guide for getting started with Actyx Pond
image: /images/defaults/default.svg
---

The Actyx Pond is a highly opinionated framework for building always-available distributed apps on [ActyxOS](../../how-to-guides/local-development/installing-actyx). It provides a programming model and system guarantees ideally suitable for use-cases requiring 100% availability. With this focus, the Actyx Pond can take care of concerns like eventual consistency, allowing you to concentrate on your business logic.
...
The best way to get started is by following the tutorial, starting with the obligatory [Hello World](../actyx-pond/guides/hello-world).
