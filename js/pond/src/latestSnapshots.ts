 ...
 */
export class LatestSnapshots<S> {
  private _semantic: Option<Event> = none
  ...
  get semantic(): Option<Event> {
    return this._semantic
  }

  set semantic(value: Option<Event>) {
    assertNewer(value, this._semantic, EventKey.ord)
