...
#[derive(Clone)]
pub struct StorageServiceStore(StorageService<super::StoreParams>);
impl StorageServiceStore {
    pub fn new(store: StorageService<super::StoreParams>) -> Self {
        Self(store)
    }
...
impl Deref for StorageServiceStore {
    type Target = StorageService<super::StoreParams>;
