...
impl Logging {
    pub fn new(rx: Receiver<ComponentRequest<()>>, level: LogSeverity, disable_color: Option<bool>) -> Self {
        let logging_sink = Arc::new(Mutex::new(LoggingSink::new(level, disable_color)));
